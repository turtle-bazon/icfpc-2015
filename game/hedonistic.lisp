...
(defparameter *sum-of-heights-factor* -10)
(defparameter *row-burn-factor* 100)
(defparameter *blockade-factor* -35)
(defparameter *touching-something-factor* 30)
(defparameter *touching-wall-factor* 25)
(defparameter *touching-floor-factor* 100)
