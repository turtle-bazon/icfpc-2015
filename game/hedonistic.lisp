...
(defparameter *sum-of-heights-factor* -1)
...
(defparameter *touching-floor-factor* 10.0)
(defparameter *row-fill-factor* 0.001)

(defun count-rows-fill (field &optional print)
